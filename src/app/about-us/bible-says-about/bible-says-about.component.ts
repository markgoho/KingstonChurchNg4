  ...
  bibleSays = [
    {
      subject: 'God',
      concept:
        'He is the Creator of all things (Genesis 1; Hebrews 3:4) and exists as the Father, Son (Jesus Christ) and Holy Spirit (Matthew 3:16-17; 28:19; 2 Corinthians 13:14).'
    },
    {
      subject: 'The Bible',
      concept:
        'The Scriptures are inspired by God and complete.  The Bible is the only reliable guide for our lives and is sufficient for all teaching, preaching, and living (2 Timothy 3:16-17).  The Scriptures are not open to multiple interpretations, and must be approached as the final word on all matters of faith.  We approach them by asking what the author’s intent was for the original readers.'
    },
    {
